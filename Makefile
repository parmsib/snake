...
#GPU-test:
lab.%: S=snake.vhd GPU/GPU.vhd GMEM/GMEM.vhd CPU/alu.vhd leddriver.vhd SPI/spi.vhd SPI/spimaster.vhd UART/UART.vhd Common/shiftregister.vhd Common/register.vhd
lab.%: T=ALU_tb.vhd
lab.%: U=lab.ucf
